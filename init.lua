...
local on_attach = function(_, bufnr)
  ...
  -- nmap('<C-k>', vim.lsp.buf.signature_help, 'Signature Documentation') -- Is this messing up my split jumps?
...
-- the python specific config fixed failures I was
-- encountering when trying to upgrade lsp within
-- Mason
require('mason').setup {
  pip = {
    upgrade_pip = true,
